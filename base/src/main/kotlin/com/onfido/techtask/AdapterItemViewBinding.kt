...
import com.onfido.techtask.ktx.inflateDataBinding

abstract class AdapterItemViewBinding<I : com.onfido.techtask.BindableItem, VDB : ViewDataBinding, VM : BaseMvRxViewModel<*>> {
    ...
    open fun bindItem(item: I, viewModel: VM) {
        ...
        viewDataBinding.setVariable(com.onfido.techtask.BR.viewBinding, this)
